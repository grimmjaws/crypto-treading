...
import com.earth.Trading.domain.PaymentOrderStatus;
import com.earth.Trading.modal.PaymentOrder;
import com.earth.Trading.modal.User;
import com.earth.Trading.repository.PaymentOrderRepository;
...
public class PaymentServiceImpl implements PaymentService{
    ...
    public PaymentResponse createRazorpayPaymentLink(User user, Long amount, Long orderId) throws RazorpayException {
        ...
        try{
            ...
            paymentLinkRequest.put("callback_url","http://localhost:5355/wallet?order_id="+orderId);
    ...
    public PaymentResponse createStripePaymentLink(User user, Long amount, Long orderId) throws StripeException {
        ...
        SessionCreateParams params = SessionCreateParams.builder()
                ...
                .setSuccessUrl("http://localhost:5355/wallet?order_id="+orderId)
                .setCancelUrl("http://localhost:5355/payment/cancel")
